...
const CURSOS_POR_CICLO = {
    ...
    sistemas: {
        ...
        6: [
            ...
            { id: 'sis_mpcv', code: 'SI603', name: 'Modelado de Procesos de Ciclo de Vida', credits: 3, formula_type: 'TEORIA_ORGANIZACIONAL', components: ['PC1', 'PC2', 'PC3', 'PC4', 'Monografia1', 'Monografia2', 'EP', 'EF', 'ES'] },
