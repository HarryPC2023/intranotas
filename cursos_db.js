...
const CURSOS_POR_CICLO = {
    ...
    sistemas: {
        ...
        3: [
            ...
            { id: 'sis_tcsa', code: 'SI301', name: 'Teoría y Ciencia de Sistemas Aplicados', credits: 2, formula_type: 'TCS', components: ['PC1', 'PC2', 'PC3', 'PC4', 'Monografia1', 'Monografia2', 'EP', 'EF', 'ES'] },
        ...
        4: [
            ...
            { id: 'sis_dp', code: 'HS102', name: 'Desarrollo Personal', credits: 2, formula_type: 'METODOLOGIA_INV', components: ['PC1', 'PC2', 'PC3', 'PC4', 'Monografia1'] },
        ...
        5: [
            ...
            { id: 'sis_dbd', code: 'SI505', name: 'Diseño de Base de Datos', credits: 3, formula_type: 'COMPUTACION_1_1_2', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
            { id: 'sis_rn', code: 'BRN01', name: 'Realidad Nacional. Constitución y DDHH', credits: 3, formula_type: 'REALIDAD_NACIONAL', components: ['PC1', 'PC2', 'PC3', 'PC4', 'Monografia1', 'Monografia2'] },
            ...
            { id: 'sis_ip', code: 'SI503', name: 'Ingeniería de Procesos', credits: 3, formula_type: 'COMPUTACION_1_1_2', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
        ],
        6: [
            { id: 'sis_sgf', code: 'GP601', name: 'Sistema y Gestión Financiera', credits: 3, formula_type: 'COMPUTACION_1_1_2', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
            { id: 'sis_mpcv', code: 'SI603', name: 'Modelado de Procesos de Ciclo de Vida', credits: 3, formula_type: 'COMPUTACION_1_1_2', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
            ...
            { id: 'sis_din', code: 'SI602', name: 'Dinámica de Sistemas', credits: 3, formula_type: 'ESTANDAR_1_1_1', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
            { id: 'sis_ads', code: 'SI604', name: 'Análisis y Diseño de Sistemas', credits: 4, formula_type: 'COMPUTACION_1_1_2', components: ['PC1', 'PC2', 'PC3', 'PC4', 'EP', 'EF', 'ES'] },
